...
- `docs/no-aquilo-design.md`: German design specification and current gameplay contract.
- `docs/testing.md`: Validation strategy, local commands, and smoke-test workflow.
- `docs/release.md`: Release packaging notes.
- `testcases.md`: Functional scenarios to verify before playable releases.
